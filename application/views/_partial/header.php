...
<head>
	...
	<title>Archive | <?php echo $meta_title; ?></title>
	<!-- Bootstrap CSS -->
  ...
  <script src="<?php echo base_url(); ?>assets/admin/assets/libs/flot/jquery.flot.categories.js"></script>
  ...
  <script src="<?php echo base_url(); ?>assets/admin/assets/libs/flot/jquery.flot.orderBars.js"></script>
